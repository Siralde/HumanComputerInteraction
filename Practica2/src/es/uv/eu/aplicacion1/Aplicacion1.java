...
public class Aplicacion1 {
    ...
    public static void main(String[] args) {
        ...
        ResumenView viewR = new ResumenView(model);
        CreadorView viewC = new CreadorView(model);
        PeliculaController controller = new PeliculaController(model, view, viewR, viewC);
