...
public class ResumenView extends JFrame {
    ...
    public ResumenView(PeliculaModel peliculas) {
        super("Aplication 1: Resumen de Peliculas");
        ...
        String lab = "Hay " + peliculas.getNumElementos() + " peliculas. La mas antigua es del año " + peliculas.getAntigua() + " y la mas moderna es del año " + peliculas.getNueva();
